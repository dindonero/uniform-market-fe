...
const BidItem: React.FC<BidItemProps> = ({
  ...
  return (
    <div className="relative flex flex-col justify-center p-2.5 w-full bg-white border-b border-gray-100 border-solid">
      ...
      {canceled && (
        <div className="absolute inset-0 z-20 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-red-500 text-white font-bold text-center px-8 py-1 opacity-75">
            Canceled
          </div>
        </div>
      )}
