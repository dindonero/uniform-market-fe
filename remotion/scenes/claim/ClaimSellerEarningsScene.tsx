...
/**
 * TC09.08 — Claiming Sold Energy Money (Seller)
 * Same flow as TC09.07 but from seller perspective with different amounts
 */
export const ClaimSellerEarningsScene: React.FC = () => {
  ...
  const balanceDisplay = balanceZero ? "0.000000" : "0.000225";
  const balanceEUR = balanceZero ? "0.00" : "0.59";
  ...
  return (
    ...
    >
          ...
          <div style={{ background: "rgba(255,255,255,0.04)", backdropFilter: "blur(24px)", borderRadius: 20, border: `1px solid ${colors.border.default}`, boxShadow: shadows.xl, padding: 28 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 13, color: colors.text.secondary }}>Seller earnings from sold energy</div>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ position: "absolute", top: 0, right: 0, width: 128, height: 128, borderRadius: "50%", background: "rgba(16,185,129,0.1)", filter: "blur(40px)" }} />
            ...
            <div style={{ padding: 16, background: "rgba(255,255,255,0.05)", borderRadius: 12, marginBottom: 24 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <div style={{ padding: 8, borderRadius: 8, background: "rgba(16,185,129,0.2)" }}>
                  <div style={{ width: 24, height: 24, borderRadius: "50%", background: "#10b981" }} />
                </div>
                <div>
                  <div style={{ fontSize: 14, fontWeight: 500, color: "white" }}>0xABCD...9876</div>
        ...
        <div style={{ position: "absolute", top: 100, right: 40, opacity: successOpacity }}>
          <div style={{ padding: "14px 24px", background: "rgba(16,185,129,0.15)", border: "1px solid rgba(16,185,129,0.3)", borderRadius: 12, display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 12, color: "rgba(52,211,153,0.7)" }}>Seller earnings sent to your wallet</div>
            </div>
          </div>
        </div>
      )}
      ...
      <Annotation text="Seller earnings from 5 kWh sold" x={650} y={350} startFrame={sec(4)} duration={sec(3)} variant="info" />
      ...
      <Annotation text="Earnings claimed from sold energy ✓" x={500} y={500} startFrame={sec(18)} duration={sec(5)} variant="success" />
    </AbsoluteFill>
  );
};
