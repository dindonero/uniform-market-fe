...
/* ------------------------------------------------------------------
   Shared icon prop types
   ------------------------------------------------------------------ */
interface IconProps {
    /** Icon width and height in pixels. Defaults vary per icon. */
    size?: number;
    /** Override fill / stroke colour. Falls back to the theme text colour. */
    color?: string;
    /** Extra Tailwind / CSS classes merged onto the root SVG / wrapper. */
    className?: string;
}

/* Convenience: common default that maps to the design-token text colour */
